 ...
 * Time: 下午9:25
 */
public class ForendLogoutSuccessUrlResolver extends AbstractLogoutSuccessUrlResolver {

    @Override
    public boolean support(Authentication authentication) {
        return ForendAuthenticationToken.class.isAssignableFrom(authentication.getClass());
    }
